        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div>
              ...
              <p className="mt-1 text-sm text-gray-500">Manage your SaaS application</p>
            </div>
            <Link
              href="/dashboard"
          ...
          <div className="bg-white overflow-hidden shadow rounded-lg">
            <div className="p-5">
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    <dt className="text-sm font-medium text-gray-500 truncate">Pro Subscriptions</dt>
                    <dd className="text-lg font-medium text-gray-900">{stats.activeProSubscriptions}</dd>
                  </dl>
                </div>
              </div>
            </div>
            ...
            <div className="p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-sm text-gray-500">Monitor and manage user subscriptions</p>
                </div>
              </div>
            </div>
          </Link>
        ...
        <div className="bg-white shadow rounded-lg">
          <div className="px-4 py-5 sm:p-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              {Object.entries(stats.monthlyRevenue).slice(-4).map(([month, count]) => (
                <div key={month} className="bg-gray-50 p-4 rounded-lg">
                  <div className="text-sm font-medium text-gray-500">{month}</div>
                  <div className="text-2xl font-bold text-gray-900">{count as number}</div>
                  <div className="text-xs text-gray-500">New Pro Subscriptions</div>
                </div>
              ))}
            </div>
          </div>
